 ...
 */
final class Version20241017092849 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE employee_event (employee_id INT NOT NULL, event_id INT NOT NULL, INDEX IDX_D3A307DE8C03F15C (employee_id), INDEX IDX_D3A307DE71F7E88B (event_id), PRIMARY KEY(employee_id, event_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
